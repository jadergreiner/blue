...
Obs: O MongoDB possui a versão Online, caso optem por não realizar a instalação. Para usar a versão On-Line, crie uma conta na Atlas.

<img src = "./imagens/ContaAtlas.png">
